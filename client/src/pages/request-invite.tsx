...
export default function RequestInvite() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    mutation.mutate({ fullName, email, city, role });
  };
          ...
          <div className="container mx-auto px-6 max-w-2xl">
            <div className="bg-card border-2 border-black p-12 text-center shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Thank you for your interest in the Replit Fellows Builder Dinner Tour. We've received your request for <strong>{city}</strong>.
              </p>
              <div className="bg-yellow-400 border-2 border-black p-6 mb-8 transform -rotate-1">
                <p className="font-bold text-black">
                  📧 Keep an eye on your inbox at <strong>{email}</strong>! We'll send you an invitation email soon with event details and next steps.
                </p>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <Select value={city} onValueChange={setCity} required>
                  <SelectTrigger data-testid="select-city" className="bg-white border-2 border-black focus-visible:ring-primary rounded-none font-medium">
              ...
              <div>
                ...
                <RadioGroup value={role} onValueChange={setRole} required className="space-y-3">
                  <div className="flex items-center space-x-3 border-2 border-border p-4 hover:bg-muted transition-colors">
                    <RadioGroupItem value="Attendee" id="attendee" data-testid="radio-attendee" className="border-2 border-black" />
                  ...
                  <div className="flex items-center space-x-3 border-2 border-border p-4 hover:bg-muted transition-colors">
                    <RadioGroupItem value="Host" id="host" data-testid="radio-host" className="border-2 border-black" />
              ...
              <Button
                ...
                disabled={mutation.isPending || !fullName || !email || !city || !role}
